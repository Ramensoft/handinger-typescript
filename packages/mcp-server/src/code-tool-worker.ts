...
import { Handinger, ClientOptions } from '@ramensoft/handinger';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Handinger)`
    : `const run: (${functionSource.client}: Handinger) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.workers.retrieveEmail',
    'client.workers.update',
    'client.workers.schedules.cancel',
    'client.workers.schedules.create',
    'client.workers.schedules.list',
    'client.workers.webhooks.delete',
    'client.workers.webhooks.listExecutions',
    'client.workers.webhooks.regenerateToken',
    'client.workers.webhooks.retrieve',
    'client.workers.webhooks.update',
    'client.tasks.create',
    'client.tasks.delete',
